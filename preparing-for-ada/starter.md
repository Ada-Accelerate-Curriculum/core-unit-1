...
Welcome to the Ada Course.  This course, through the "Learn" Learning Management System, is a major tool we will use in your education at Ada.  The first units are Pre-Ada units you will need to complete **prior to starting at Ada**.

The purpose of the Pre-Ada unit is to keep you coding (and talking about code) between admissions and the first day of class. You should understand the topics covered in the precourse and practice this understanding with the assignments provided. Take this opportunity to meet and study with peers in your cohort.  You will have been invited to the Cohort Slack, and we will set up a channel to discuss the course and coding challenges.  **Take advantage of it.**

All admitted students are expected to be well-versed with the concepts covered in Precourse on the first day of their cohort. This includes conditional flows, loops, functions, lists, dictionaries and Python basics. We recognize that Adies admitted to Accelerate have a diverse range of programming backgrounds. As such, we encourage you to skim through all of the material and focus on diving deeper into whichever topics will strengthen your programming skills the most.

As you complete each assignment you will recieve feedback, some of which is automated and some of which is not.  We are relatively new to using the Learn platform from [Galvanize](https://www.galvanize.com/), and as such there will be bumps in the process.  **Please be patient with bugs and let us know on Slack, so we can fix them.**
